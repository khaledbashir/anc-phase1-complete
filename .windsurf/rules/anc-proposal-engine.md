...
# ANC Proposal Engine — Complete Rules for Windsurf

> **READ THIS FIRST:** These rules are mandatory. Violation = rejection.
...
### Cascade Behavior
- Cascade is the AI assistant in Windsurf.
- It can run terminal commands, edit files, and search the codebase.
- Always review Cascade's proposed changes before accepting.

### Composer
- Use Composer for multi-file edits and complex changes.
- Composer can generate, edit, and refactor code across multiple files.
- Review all changes in the diff view before applying.

### Terminal
- Cascade can execute terminal commands.
- Be cautious with destructive commands (rm, drop database, etc.).
- Review commands before execution.

### Supercomplete
- Windsurf provides intelligent autocomplete.
- Use it to speed up coding, but verify the suggestions are correct.
